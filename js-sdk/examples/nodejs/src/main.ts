...
async function main() {
  ...
  const plissken_server_endpoint = 'http://127.0.0.1:3223';
  const business_server_endpoint = 'http://127.0.0.1:3224';
  try {
    ...
    console.log('Getting the same value from the business server');
