...
const plissken_auth_endpoint = process.env.REACT_APP_PLISSKEN_AUTH_SERVER_URL;
const resource_server_endpoint =
  process.env.REACT_APP_PLISSKEN_RESOURCE_SERVER_URL;
